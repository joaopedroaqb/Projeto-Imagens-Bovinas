...
transform_train = transforms.Compose(
    [
      ...
      transforms.RandomRotation(10),  # Adicione uma rotação aleatória
      transforms.ToTensor()
    ]
)
...
optimizer = optim.SGD(net.parameters(), lr=0.03, momentum=0.0, weight_decay=0.01)  # Taxa de aprendizado menor e regularização L2
